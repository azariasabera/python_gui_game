...
An advanced project to create a game using tkinter.

152229878
Azarias Galama
azarias.galama@tuni.fi

-----------------------
GAME DESCRIPTION
-----------------------
The following game is a game where the user has to guess the city in the picture. The game has 10 question pictures.
Each picture has four choices. The user has to choose the correct city name from the four choices.
The user can choose to play again or quit after the game has ended.
After the game has ended, the total score is displayed. The total score is the number of correct answers out of 10.
"""
...
class GuessCity:
    ...
    def __init__(self):
        ...
        self.__end_image = PhotoImage(file="end.gif")  # image displayed once the game has ended

        # Below are buttons and labels that are displayed in the start menu
        # ================================================================================================== #
        start, info, close = PhotoImage(file="start.gif"), PhotoImage(file="info.gif"), PhotoImage(file="close.gif")
